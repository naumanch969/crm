...
const taskSlice = createSlice({
    ...
    reducers: {
        ...
        getTasksReducer: (state, action) => { state.currentTask = action.payload },
        getTaskReducer: (state, action) => { state.tasks = action.payload },
        createTaskReducer: (state, action) => { state.tasks = [...state.tasks, action.payload] },
