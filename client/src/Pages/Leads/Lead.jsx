              ...
              <div className="md:flex text-[#67757c]">
                <div className="bg-white md:w-8/12 w-full h-full px-4">
                  ...
                  <div className="text-lg font-[350] pb-2">
                    Beds Required : <span className="text-black font-normal">{currentLead?.beds}</span>
                  </div>
                  ...
                  <div className="text-lg font-[350] pb-2">
                    Specific Area : <span className="text-black font-normal">{currentLead?.region}</span>
                  </div>
                  ...
                  <Divider />
                  <div className="pt-2 text-lg font-[350]">
                    Minimum Area : <span className="text-black font-normal">{currentLead?.minArea}</span>
                  </div>
                  <div className="text-lg font-[350] pb-2">
                    Maximum Area : <span className="text-black font-normal">{currentLead?.maxArea}</span>
                  </div>
                  ...
                  <Divider />
                  <div className="pt-2 text-lg font-[350]">
                    Minimum Budget : <span className="text-black font-normal">{currentLead?.minBudget}</span>
                  </div>
                  <div className="text-lg font-[350] pb-2">
                    Maximum Budget : <span className="text-black font-normal">{currentLead?.maxBudget}</span>
                  </div>
                </div>
