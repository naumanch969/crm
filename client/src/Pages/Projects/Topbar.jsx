    ...
    <div className='flex justify-between items-center ' >
      ...
      <div className='flex justify-end items-center gap-[6px] '>
        ...
        <div className="flex justify-start items-center gap-[6px]">
          <Tooltip placement='top' title='Show Archived Projects' >
          ...
          <Tooltip placement='top' title='My Projects' >
          ...
          <Tooltip placement='top' title='Import Projects' >
            <div className="w-[32px] h-[32px] flex justify-center items-center cursor-pointer bg-secondary-gray rounded-[4px] ">
        ...
        <button onClick={() => navigate('/projects/create')} className="bg-primary-red text-white w-[44px] h-[44px] flex justify-center items-center rounded-full shadow-lg ">
          <Add />
        </button>
      </div>
