...
const CreateUser = () => {
    ...
    return (
        <div className='flex flex-col gap-[2rem] bg-white px-[20px] py-[1rem] shadow-md ' >
            ...
            <form onSubmit={handleSubmit} className='flex gap-[3rem] w-full ' >
                ...
                <div className="flex-[1] flex flex-col gap-[1rem]  ">
                    ...
                    <div className="flex flex-col gap-[4px] ">
                        ...
                        <select onChange={handleChange} value={userData.branch} name="branch" className='bg-inherit border-[1px] border-gray-500 text-black outline-none rounded-[4px] p-[8px] ' >
                    ...
                    <div className="flex flex-col gap-[4px] ">
                        ...
                        <select onChange={handleChange} value={userData.salaryType} name="salaryType" className='bg-inherit border-[1px] border-gray-500 text-black outline-none rounded-[4px] p-[8px] ' >
                    ...
                    <button type='submit' className='w-fit text-gray-900 bg-gray-200 border-[1px] border-gray-800 px-[12px] py-[4px] rounded-[4px] cursor-pointer ' >Save</button>
                </div>
                ...
                <div className="flex-[1] flex flex-col gap-[1rem]  ">
                    ...
                    <div className="flex justify-between items-center gap-[4px] ">
                        ...
                        <div className="flex-[1] flex flex-col items-start justify-start ">
                            ...
                            <input type="checkbox" onChange={handleChange} value={userData.activeStatus} name="activeStatus" id="activeStatus" className='h-[40px]' />
                        </div>
                        {/* cnic */}
                        <div className="flex-[1] ">
                            <label className='text-black font-medium text-[16px] ' htmlFor='cnic' >CNIC</label>
                            <input type="number" onChange={handleChange} value={userData.cnic} name="cnic" id="cnic" placeholder='CNIC' className='bg-inherit border-[1px] border-gray-500 text-black outline-none rounded-[4px] p-[8px] ' />
                        </div>
                    </div>
                </div>
