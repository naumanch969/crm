...
const Sidebar = ({ showSidebar, setShowSidebar }) => {
    ...
    return (
        <>
            {/* desktop sidebar */}
            <Box className={`w-[15vw] sticky top-0 flex flex-col shadow-none h-screen  ${showSidebar ? 'md:flex hidden' : 'hidden'} bg-white z-[1000] border-r-[1px] border-r-gray-300 border-b-[1px] border-b-gray-300`} >
